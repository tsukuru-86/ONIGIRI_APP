...
import 'package:onigiri_app/Numbers/10-100/page5.dart';
import 'package:onigiri_app/Numbers/10-100/page7.dart';
import 'package:onigiri_app/Numbers/Numbers.dart';
import 'package:onigiri_app/colors.dart';
import 'package:video_player/video_player.dart';

class Num10PAGE6 extends StatefulWidget {
  @override
  _HomeState createState() => _HomeState();
}

class _HomeState extends State<Num10PAGE6> {
  ...
  loadVideoPlayer() {
    controller = VideoPlayerController.asset(
        'assets/videos/Numbers/10-100/Numbers10-100-6.mp4');
