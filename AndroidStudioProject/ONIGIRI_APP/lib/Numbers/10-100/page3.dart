...
class Num10PAGE3 extends StatefulWidget {
  @override
  _HomeState createState() => _HomeState();
}

class _HomeState extends State<Num10PAGE3> {
  ...
  loadVideoPlayer() {
    controller = VideoPlayerController.asset(
        'assets/videos/Numbers/10-100/Numbers10-100-3.mp4');
