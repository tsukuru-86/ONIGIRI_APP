...
import 'package:onigiri_app/Numbers/10-100/page3.dart';
...
class Num10PAGE4 extends StatefulWidget {
  @override
  _HomeState createState() => _HomeState();
}

class _HomeState extends State<Num10PAGE4> {
  ...
  loadVideoPlayer() {
    controller = VideoPlayerController.asset(
        'assets/videos/Numbers/10-100/Numbers10-100-4.mp4');
