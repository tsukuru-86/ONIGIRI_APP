...
class Num10PAGE1 extends StatefulWidget {
  @override
  _HomeState createState() => _HomeState();
}

class _HomeState extends State<Num10PAGE1> {
  ...
  loadVideoPlayer() {
    controller = VideoPlayerController.asset(
        'assets/videos/Numbers/10-100/Numbers10-100-1.mp4');
